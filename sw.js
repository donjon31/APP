const CACHE='puls-shell-harpex-rhythm-v2';
const BASE=self.registration.scope;
const ASSETS=['','app.html','app.html?v=rhythm-2','simulator.js?v=4','simulator.css?v=3','app.js','experience.js?v=rhythm-2','theme.css?v=simulator-3','identity.js?v=1','identity.css?v=2','manifest.webmanifest','harpex-icon.svg','harpex-icon-192.png','harpex-icon-512.png','foedevarer-skabelon.csv'].map(path=>BASE+path);
